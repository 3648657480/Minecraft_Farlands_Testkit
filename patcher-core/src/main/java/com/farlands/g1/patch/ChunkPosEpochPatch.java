 ...
 * {@code hashCode()}, {@code equals()} and the block-boundary accessors,
 * so the entire chunk storage domain (ChunkMap, client cache, structure
 * managers, WorldGenRegion centers) keys on small epoch-relative ints.
