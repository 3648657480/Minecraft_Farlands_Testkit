...
| **1,808,764,368,950,000,000,099,728**（≈1.80876436895×10^24） | 本项目条件下测得的"主地形改变/条板墙结构"起点 | 疑似 `PerlinNoise.wrap()` 取整失效（待归因） | 本项目条件下实测（人工二分） |
...
**F3 显示（本项目 v0.5.2+）**：XYZ/Block/Chunk 显示真实坐标（超 double 精度用 BigInteger 精确值）；
