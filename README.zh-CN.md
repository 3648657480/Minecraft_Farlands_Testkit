...
| **边境之地「奶酪墙」（想看的那个）** | **`1808764368955220359643137`** |
| 1e306 / double 极限 | `1e306` |

（⚠️ 别去 k0 `1808764368955220493860864` 找墙——那里只有 256 平台；可见的奶酪墙在
`1808764368955220359643137` = k0 − (2²⁷−1)。详见 `docs/EXPERIMENTS.md` §8.4。）
